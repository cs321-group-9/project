...
public class DataBase extends SQLiteOpenHelper{
	...
	public final static String NumWeek ="zhoushu";
	public final static String NumCourse ="jieshu";
	...
	public void update(int i,int _id,String cla,String loca,String tea,String zhou,String jie,String time1,String time2,String which){
		...
		if(!zhou.equals("")) cv.put(NumWeek,zhou);
		if(!jie.equals("")) cv.put(NumCourse,jie);
